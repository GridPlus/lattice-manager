...
class Settings extends React.Component<any, any> {
  ...
  submit() {
    ...
    store.setSettings(this.state.settings);
      ...
      <Card>
        <Row justify="center">
          <Col span={20}>
            ...
            <p>
              If you wish to route messages and connections through your own
              endpoint, you may specify it here.&nbsp; Otherwise leave
              blank.&nbsp; See&nbsp;
              <a
                href="https://github.com/GridPlus/lattice-connect"
                className="lattice-a"
                target="_blank"
  ...
  renderBitcoinVersionSetting() {
    ...
    return (
      <Card>
        ...
        <Radio.Group
          onChange={this.handleChangeBitcoinVersionSetting.bind(this)}
    ...
    return (
      <Card>
        ...
        <Row justify="center" style={{ margin: "20px 0 0 0" }}>
          <Checkbox
            onChange={this.updateUseDevLattice.bind(this)}
            checked={devLattice}
          >
            Using Dev Lattice
          </Checkbox>
      ...
      <Card>
        <Row justify="center">
          <Col span={20}>
            ...
            <p>
              Manage connections to your Lattice. Third party apps should be
              listed here if they are connected to your device.
            </p>
            <Collapse>
              <Collapse.Panel
                header={`Connections List (${data.length})`}
                key="third-party"
              >
  ...
  render() {
    ...
    if (this.props.inModal) return <center>{this.renderCard()}</center>;
